...
<div class="wrapper">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer bg-blue">
                                    <div class="pull-left">
                                        <a href="<?= Yii::$app->urlManager->baseUrl ?>/index.php?r=user/update&prof=true&id=<?= Yii::$app->session['user']->id ?>"
                                           class="btn bg-green btn-sm"><span class="fa fa-cogs"></span></a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="<?= Yii::$app->urlManager->baseUrl ?>/index.php?r=site/logout"
    ...
    if (empty(\Yii::$app->session['user'])) {
        ...
        <footer class="main-footer">
            ...
            ໂທ: <?= Yii::$app->params['phone'] ?> | ອີເມວ: <?= Yii::$app->params['email'] ?>
        </footer>
        <?php
