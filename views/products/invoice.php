    ...
    <div class="table-responsive" id="print">
        ...
        <table class="table" style="font-size:9px !important;">
            ...
            ?>
                ...
                <tr>
                    <td colspan="2" align="right"><?= Yii::t('app', '​ຈຳ​ນວນ​ເງ​ີນຈ່າຍ')."(".Yii::t('app', 'LAK').")"?>
                    </td>
                    <td align="right">​<b><?= number_format($multi_currency_pay->amount_kip, 2) ?></b></td>
                </tr>
                <tr>
                    <td colspan="2" align="right"><?= Yii::t('app', '​ຈຳ​ນວນ​ເງ​ີນຈ່າຍ')."(".Yii::t('app', 'TH').")"?>
                    </td>
                    <td align="right">​<b><?= number_format($multi_currency_pay->amount_th, 2) ?></b></td>
                </tr>
                <tr>
                    <td colspan="2" align="right"><?= Yii::t('app', '​ຈຳ​ນວນ​ເງ​ີນຈ່າຍ')."(".Yii::t('app', 'USD').")"?>
                    </td>
