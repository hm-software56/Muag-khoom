Contributing to yii2-editable
=============================
Looking to contribute something to yii2-editable? **Here's how you can help.**
...
- What version of jQuery are you using? And what version of yii2-editable?
- Are you using yii2-editable with other plugins?
...
yii2-editable regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to yii2-editable that contain test cases and
...
It should also be made clear that **all code contributed to yii2-editable** must be
...
[reporting-bugs]: #reporting-bugs-with-yii2-editable
[requesting-features]: #requesting-features-in-yii2-editable