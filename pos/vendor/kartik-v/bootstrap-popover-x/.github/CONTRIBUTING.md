Contributing to bootstrap-popover-x
===================================
Looking to contribute something to bootstrap-popover-x? **Here's how you can help.**
...
[plugin documentation](http://plugins.krajee.com/popover-x), 
[plugin demos](http://plugins.krajee.com/popover-x/demo), and / or refer to the
[webtips Q & A forum](http://webtips.krajee.com/questions) which are the better places to get help.

Reporting bugs with bootstrap-popover-x
---------------------------------------
We really appreciate clear bug reports that _consistently_ show an issue
_within bootstrap-popover-x_.
...
- What version of jQuery are you using? And what version of bootstrap-popover-x?
- Are you using bootstrap-popover-x with other plugins?

All of these questions will help others fix and identify any potential bugs.

Requesting features in bootstrap-popover-x
------------------------------------------
Before starting work on a major feature for bootstrap-popover-x, **read the
[documentation](http://plugins.krajee.com/popover-x)  first** or you may risk spending a considerable amount of
...
bootstrap-popover-x regularly receives new issues which need to be tested and organized.
...
If you can test issues that are reported to bootstrap-popover-x that contain test cases and
...
It should also be made clear that **all code contributed to bootstrap-popover-x** must be
licensable under the [BSD-3 license][licensing].  Code that cannot be released
under this license **cannot be accepted** into the project.

[isolated-case]: https://jsfiddle.net/
[issue-search]: https://github.com/kartik-v/bootstrap-popover-x/search?q=&type=Issues
[issue-tracker]: https://github.com/kartik-v/bootstrap-popover-x/issues
[licensing]: https://github.com/kartik-v/bootstrap-popover-x/blob/master/LICENSE.md
[reporting-bugs]: #reporting-bugs-with-bootstrap-popover-x
[requesting-features]: #requesting-features-in-bootstrap-popover-x